...
def generate_launch_description():
        ...
        parameters=[
            {
                ...
                "rgb_camera.brightness": 0,  # Fixed brightness
                "rgb_camera.contrast": 50,  # Fixed contrast
        ...
        parameters=[
            {
                ...
                "RGBD/AngularUpdate": "1.00",  # Added from documentation
                "RGBD/LinearUpdate": "1.00",  # Added from documentation
                "RGBD/OptimizeMaxError": "1.5",  # Added from documentation
                ...
                "Icp/MaxTranslation": "0.7", # Added by Azzam
                ...
                'Grid/UpdateRate': "0.2",  # Update map every 1 second (default is often higher)
                ...
                "GridGlobal/UpdateError": "0.01", # Added by Azzam
    ...
    tf_base_link_to_camera_link = Node(
        ...
        name="tf_base_link_to_camera_link",
        # fmt: off
        arguments=["0.0","0.00","0.28","0.0","0.523","0.0","base_link","camera_link",
            "--ros-args","--log-level","error",],
        # fmt: on
        respawn=True,
    )
