...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.auto_exposure_priority', 'default': 'false', 'description': 'enable/disable auto exposure priority for color image'},
                           {'name': 'rgb_camera.exposure',          'default': '300', 'description': 'color image manual exposure value'},
                           {'name': 'rgb_camera.enable_auto_white_balance', 'default': 'false', 'description': 'enable/disable auto white balance for color image'},
                           {'name': 'rgb_camera.white_balance',     'default': '5000', 'description': 'color image manual white balance value'},
                           {'name': 'rgb_camera.brightness',        'default': '-64', 'description': 'color image brightness value -64 to 64'},
                           {'name': 'rgb_camera.contrast',          'default': '100', 'description': 'color image contrast value 0 to 100'},
                           {'name': 'rgb_camera.saturation',        'default': '50', 'description': 'color image saturation value 0 to 100'},
                           {'name': 'rgb_camera.power_line_frequency', 'default': '2', 'description': '[0-Disabled, 1-50Hz, 2-60Hz] power line frequency for color image'},
                        #    {'name': 'rgb_camera.sharpness',         'default': '0', 'description': 'color image sharpness value'},
                        #    {'name': 'rgb_camera.hue',              'default': '0', 'description': 'color image hue value'},
                        #    {'name': 'rgb_camera.gamma',             'default': '100', 'description': 'color image gamma value'},
                        
                           {'name': 'depth_module.depth_profile',   'default': '640,360,60', 'description': 'depth stream profile'},
                           {'name': 'depth_module.depth_format',    'default': 'Z16', 'description': 'depth stream format'},
                           {'name': 'depth_module.infra_profile',   'default': '640,360,60', 'description': 'infra streams (0/1/2) profile'},
                           ...
                           {'name': 'pointcloud.filter_magnitude',        'default': '2', 'description': ''},
                           ...
                           {'name': 'decimation_filter.filter_magnitude',     'default': '1', 'description': ''},
