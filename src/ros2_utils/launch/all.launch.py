...
def generate_launch_description():
    ...
    pkg_share = get_package_share_directory('ros2_utils')
    rs_launch_path  = os.path.join(pkg_share, 'launch', 'rs_launch.py')
        ...
        parameters=[
            {
                ...
                # "rgb_camera.power_line_frequency": "60Hz",
    ...
    master = Node(
        ...
        parameters= [
            {
                "profile_max_acceleration" : 8.0,
                "profile_max_decceleration" : 8.0,
                "profile_max_velocity" : 3.0, 
                "profile_max_accelerate_jerk" : 1600.0,
                "profile_max_decelerate_jerk" : 16000.0,
                "profile_max_braking" : 3.0,
                "profile_max_braking_acceleration" :8.0,
                "profile_max_braking_jerk" : 1600.0,
                "profile_max_steering_rad" : 0.61, 
                "wheelbase" : 0.27,
        ...
        parameters=[
            {
                ...
                # "encoder_ppr": 147906.25,
                # "cnt_to_meter":  1.0,
                # "max_steering_deg": 37.5,
                # "min_steering_deg": -37.5,
                # "max_steering_pwm": 1100.0,
                # "min_steering_pwm": 800.0,
                # "mid_steering_pwm": 950.0,
                # "max_wheel_velocity_pwm": 8000.0,
                # "min_wheel_velocity_pwm": -8000.0,
                # "max_wheel_integral_pwm": 2500.0,
                # "min_wheel_integral_pwm": -2500.0,
                # "wheel_base": 0.22000,  # Distance between the wheels (m)
            }
        ],
        # prefix='nice -n -10',
    )
    ...
    vision_capture2 = Node(
        package='vision',
        executable='vision_capture2',
        name='vision_capture2',
        output='screen',
        respawn=True,
        parameters=[
            {
                # Tuning jalan dalam berlawanan jarum jam (kiri)
                # Kecepatan 0.6 m/s pasangan lookahead 0.2-0.3 m
                # Kecepatan 0.8 m/s pasangan lookahead 0.3-0.4 m
                # Kecepatan 1.0 m/s pasangan lookahead 0.35-0.4 m
                # Kecepatan 1.2 m/s pasangan lookahead 0.37-0.42 m (osilasi keluar jalur)
                # Line length 10-25 pixel, 15-30 pixel untuk pinggir jalan

                # Tuning jalan luar berlawanan jarum jam (kanan)
                # Kecepatan 0.6 m/s pasangan lookahead 0.2-0.3 m
                # Kecepatan 0.8 m/s pasangan lookahead 0.3-0.4 m
                # Kecepatan 1.0 m/s pasangan lookahead 0.35-0.4 m
                # Kecepatan 1.2 m/s pasangan lookahead 0.37-0.42 m (osilasi keluar jalur)
                # Line length 47-38 pixel, 8-22 pixel untuk pinggir jalan

                # Tuning jalan dalam searah jarum jam (kanan)
                # Kecepatan 0.6 m/s pasangan lookahead 0.2-0.3 m
                # Kecepatan 0.8 m/s pasangan lookahead 0.3-0.4 m
                # Kecepatan 1.0 m/s pasangan lookahead 0.35-0.4 m
                # Kecepatan 1.2 m/s pasangan lookahead 0.37-0.42 m (osilasi keluar jalur)
                # Line length 20-35 pixel, 13-27 pixel untuk pinggir jalan

                # Tuning jalan luar searah jarum jam (kiri)
                # Kecepatan 0.6 m/s pasangan lookahead 0.2-0.3 m
                # Kecepatan 0.8 m/s pasangan lookahead 0.3-0.4 m
                # Kecepatan 1.0 m/s pasangan lookahead 0.35-0.4 m
                # Kecepatan 1.2 m/s pasangan lookahead 0.37-0.42 m (osilasi keluar jalur)
                # Line length 30-27 pixel, 17-15 pixel untuk pinggir jalan

                # "lookahead_far_meter": 0.42,
                # "lookahead_near_meter": 0.37,
                # "meter_to_pixel": 272.7272727,  # Conversion factor from meters to pixels 227.2727203
                # "wheelbase": 0.23,  # Distance between the wheels (m)
                # "max_steering_deg": 35.0,
                # "line_length_min": 20.0,  # in pixels
                # "line_length_max": 25.0,  # in pixels
                # "line_length_edge_min": 30.0,  # in pixels
                # "line_length_edge_max": 35.0,  # in pixels
                # "speed_straight": 1.0,
                # "speed_wiggle": 8.0,
                # "speed_curve": 0.6,
                # "lookahead_straight": 100.0,  # in pixels
                # "lookahead_wiggle": 95.0,    # in pixels
                # "lookahead_curve": 85.0,       # in pixels
                # "valid_center_left": 120,
                # "valid_center_right": 280,
                # "valid_up": 415,
                # "valid_down": 600,
                # "cropping_distance": 300,
                # "used_lane": 1,  # 0 = kiri, 1 = kanan
                # "record_vision": 0,
                # "kp_steering": 30.0,
                # "ki_steering": 0.0,
                # "kd_steering": 0.0,
    ...
    vision_capture3 = Node(
        package='vision',
        executable='vision_capture3',
        name='vision_capture3',
        output='screen',
        respawn=True,
        parameters=[
            {
                "lookahead_far_meter": 0.3,
                "lookahead_near_meter": 0.3,
                "meter_to_pixel": 272.7272727,  # Conversion factor from meters to pixels
                "max_steering_deg": 35.0,
                "wheelbase": 0.23,  # Distance between the wheels (m)
                "kp_steering": 30.0,
                "ki_steering": 0.0,
    ...
    vision_capture4 = Node(
        package='vision',
        executable='vision_capture4',
        name='vision_capture4',
        output='screen',
        respawn=True,
        parameters=[
            {
    ...
    detection_urban = Node(
        package='vision',
        executable='detection_urban',
        name='detection_urban',
        output='screen',
        parameters=[
             {
                "lookahead_far_meter": 0.3,
    ...
    yolo_detection = Node(
        ...
        parameters=[
            {
                "model_path": "/home/iris/best_fira3_openvino_model/",
                "confidence_threshold": 0.6,
                "iou_threshold": 0.7,
                "camera_string": "/dev/v4l/by-id/usb-e-con_systems_See3CAM_CU55_14205401-video-index0",
            }
        ],
    )
        ...
        parameters=[
            {
                ...
                'Icp/PointToPlaneMinComplexity':'0.01', # to be more robust to long corridors with low geometry
    ...
    tf_base_link_to_camera_iris = Node(
        ...
        # fmt: off
        arguments=["0.114","0.00","0.418","0.0","0.67","0.0","base_link","camera_iris",
            "--ros-args","--log-level","error",],
        # fmt: on
        respawn=True,
    )
