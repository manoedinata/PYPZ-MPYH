#ifndef VISION_CAPTURE2_HPP
#define VISION_CAPTURE2_HPP
// C++ Standard Library
#include <algorithm>
#include <chrono>
#include <iostream>
...
class VisionCapture2 : public rclcpp::Node
{
  private:
    // -------------------------------------------------
    // Transform
  ...
  private:
    ...
    void setup_signal_handlers()
    {
        std::signal(SIGINT, [](int)
                    {
            RCLCPP_INFO(rclcpp::get_logger("vision_capture2"), "Received SIGINT, shutting down gracefully...");
            rclcpp::shutdown(); });

        std::signal(SIGTERM, [](int)
                    {
            RCLCPP_INFO(rclcpp::get_logger("vision_capture2"), "Received SIGTERM, shutting down gracefully...");
            rclcpp::shutdown(); });
    }
